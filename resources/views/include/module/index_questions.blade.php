    ...
    <div class="questions__wrapper">
        <div class="index_questions__flex">
            <div class="index_questions__left">
                ...
                <div class="l__social">
                    <div class="s__1">
                        <a target="_blank" href="{{config('config.whatsapp')}}">
                    ...
                    <div class="s__2">
                        <a target="_blank" href="{{config('config.telegram')}}">
                    ...
                    <div class="s__3">
                        <a target="_blank" href="mailto:{{config('config.email')}}">

                        ...
                        <div class="hbox__middle country_page ">
                            ...
                            @if($category->pageimg1)
                                <div class="pageimg pad_t16 pad_b16">
                                    <img src="{{ asset(intervention('892x516', $category->pageimg1, 'travels')) }}" width="892" height="516" loading="lazy"
                                         alt="{{$category->title}}" />
                                </div>
                            @endif
                            ...
                            @if($category->pageimg2)
                                <div class="pageimg2 pad_t16 pad_b16">
                                    ...
                                    <img src="{{ asset(intervention('892x516', $category->pageimg2, 'travels')) }}" width="892" height="516" loading="lazy"

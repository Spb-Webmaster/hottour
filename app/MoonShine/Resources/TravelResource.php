...
/**
 * @extends ModelResource<Travel>
 */
class TravelResource extends TreeResource
{
    protected string $model = Travel::class;

    protected string $title = 'Travel';
                        ...
                        Grid::make([
                            ...
                            Column::make([
                                ...
                                Collapse::make('Вложенность', [
                                    BelongsTo::make('Категория', 'parent', resource: new TravelResource())->nullable()->searchable(),
